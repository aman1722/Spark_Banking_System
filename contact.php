...
<head>
  ...
  <title>Contact Me - The Sparks Bank</title>
  ...
  <style>
    <?php include 'css/style.css'; ?><?php include 'css/contact.css'; ?>
  </style>
...
<body>
  ...
  <div class="contact">
    <h1>Contact Me</h1>
    <div class="icons">
      <a href="https://www.linkedin.com/in/harsh-anand-kumar-83aa0b215"><i class="fab fa-linkedin"></i></a>
      <a href="https://www.instagram.com/saundiksonu/"><i class="fab fa-instagram"></i></a>
      <a href="https://github.com/Harsh0501"><i class="fab fa-github"></i></a>
      <a href="#"><i class="fab fa-twitter"></i></a>
    </div>
  </div>
  <footer><small>&copy; Copyright 2023, Harsh Anand Kumar</small></footer>
</body>
